...
const Alert = ({className, message, variant="error", onClose, autoDismiss = true, dismissTime = 2000, ...otherProps}) => {

    // Dismiss alert message after some time if the user doesn't close it manually
    useEffect(() => {
